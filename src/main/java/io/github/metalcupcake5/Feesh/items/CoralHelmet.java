...
public class CoralHelmet extends ItemType {
    public CoralHelmet() {
        super("CORAL_HELMET");
    }
    ...
    public ItemStack makeNewStack() {
        ...
        meta.setDisplayName(ChatColor.DARK_PURPLE + "Coral Helmet");
        ...
        lores.add("" + ChatColor.DARK_PURPLE + ChatColor.BOLD + "EPIC HELMET");
        meta.setLore(lores);
