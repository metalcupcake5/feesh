...
public class CoralChestplate extends ItemType {
    public CoralChestplate() {
        super("CORAL_CHESTPLATE");
    }
    ...
    public ItemStack makeNewStack() {
        ...
        meta.setDisplayName(ChatColor.DARK_PURPLE + "Coral Chestplate");
        ...
        lores.add("" + ChatColor.DARK_PURPLE + ChatColor.BOLD + "EPIC CHESTPATE");
        meta.setLore(lores);
