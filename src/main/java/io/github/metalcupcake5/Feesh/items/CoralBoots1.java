...
public class CoralBoots1 extends ItemType {
    public CoralBoots1() {
        super("CORAL_BOOTS_1");
    }
    ...
    public ItemStack makeNewStack() {
        ...
        meta.setDisplayName(ChatColor.GOLD + "Infused Coral Boots");
        ...
        lores.add("" + ChatColor.GOLD + ChatColor.BOLD + "LEGENDARY BOOTS");
        meta.setLore(lores);
