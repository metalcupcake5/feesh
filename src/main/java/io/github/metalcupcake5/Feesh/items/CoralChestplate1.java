...
public class CoralChestplate1 extends ItemType {
    public CoralChestplate1() {
        super("CORAL_CHESTPLATE_1");
    }
    ...
    public ItemStack makeNewStack() {
        ...
        meta.setDisplayName(ChatColor.GOLD + "Infused Coral Chestplate");
