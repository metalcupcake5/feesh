...
public class CoralLeggings extends ItemType {
    public CoralLeggings() {
        super("CORAL_LEGGINGS");
    }
    ...
    public ItemStack makeNewStack() {
        ...
        meta.setDisplayName(ChatColor.DARK_PURPLE + "Coral Leggings");
        ...
        lores.add("" + ChatColor.DARK_PURPLE + ChatColor.BOLD + "EPIC LEGGINGS");
        meta.setLore(lores);
