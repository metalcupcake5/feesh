...
public class CoralHelmet2 extends ItemType {
    public CoralHelmet2() {
        super("CORAL_HELMET_2");
    }
    ...
    public ItemStack makeNewStack() {
        ...
        meta.setDisplayName(ChatColor.GOLD + "Infused Coral Helmet");
        ...
        lores.add("" + ChatColor.GOLD + ChatColor.BOLD + "LEGENDARY HELMET");
        meta.setLore(lores);
